...
GDSC_SE_FILE <- file.path( "..", "objects", "gdsc_se_l.rds" )
GDSC1_DATA_FILE <- file.path( "..", "downloads", "GDSC1_fitted_dose_response_25Feb20.xlsx" )
GDSC2_DATA_FILE <- file.path( "..", "downloads", "GDSC2_fitted_dose_response_25Feb20.xlsx" )
